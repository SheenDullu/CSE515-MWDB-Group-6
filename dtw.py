...
def DTWDist(seq1, seq1Index, seq2, seq2Index):
    if(seq1Index==0 and seq2Index==0):
        ...
        + min(DTWDist(seq1,seq1Index-1,seq2,seq2Index), DTWDist(seq1,seq1Index,seq2,seq2Index-1), DTWDist(seq1,seq1Index-1,seq2,seq2Index-1))

# EXAMPLE RUN
# dynamicTimeWarping("Data","5.wrd")